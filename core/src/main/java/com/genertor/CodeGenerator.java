...
public class CodeGenerator {
	...
	public static void main(String[] args) throws Exception{
		//codeGenerator(ExpAccountGrantRecord.class);
	...
	private static void codeGenerator(Class clazz) throws Exception {
		...
		createFile("Mapper.xml","src/main/java/{0}/mapper/{1}Mapper.xml",classInfo);
		//生成Service
	 ...
	 * @throws Exception
	 */
	private static void createFile(String templateName,String outPath,ClassInfo classInfo,boolean notReplace) throws Exception{
