		...
		$("#editForm").validate({
			...
			submitHandler:function(form){
				$(form).ajaxSubmit(function(data){
					window.location.href="/expBidRequest_list";
				});
			},
			//自定义错误样式
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form class="form-horizontal el-borrow-form" id="editForm" novalidate="novalidate" method="post" action="/expBidRequestPublish">
