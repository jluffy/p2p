<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		<a href="#" data-toggle="collapse" data-target="#permissionmanage_detail">
			<span>体验标管理</span></a>
		<ul class="in" id="auditmaneg_detail">
			<li class="expBidRequestPublish"><a href="/expBidRequestPublishPage"><span>发布体验标</span></a></li>
			<li class="expbidrequestlist"><a href="/expBidRequest_list"><span>体验标管理</span></a></li>
		</ul>
	</li>
	<li class="list-group-item">
