...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#myModal [name=id]").val(data.id);//隐藏域中的值 做提交用
...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign currentMenu="bidrequest_publishaudit_list" />
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/bidrequest_publishaudit_list">
				...
				<div class="panel panel-default">
					<table class="table">
						...
						<#list pageResult.listData as data>
							<tr>
								<td>
									<a target="_blank" href="/borrow_info?id=${data.id}">${data.title}</a>&emsp;
									<span class="label label-primary">${bidRequestTypeDisplay}</span>
								</td>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/bidrequest_publishaudit">
					<fieldset>
						<div id="legend" class="">
							<legend>发标前审核</legend>
						</div>
