...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign currentMenu="bidrequest_audit2_list" />
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/bidrequest_audit2_list">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-body">
      	<form class="form-horizontal" id="editform" method="post" action="/bidrequest_audit2">
			<fieldset>
				<div id="legend" class="">
					<legend>满标二审</legend>
				</div>
