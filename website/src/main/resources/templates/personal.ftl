                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            var timer = window.setInterval(function () {
                                count--;
                                if (count > 0) {//修改按钮文本值
                                    _this.text(count + "s后重新发送验证码");
                                } else {
                                    //清除计时器
                                    window.clearInterval(timer);
                                    _this.prop("disabled", false);//点亮
                                    //文本改成可以发送
                                    _this.text("发送验证码");
                                }
                            }, 1000)
            ...
            <div class="panel panel-default">
                <div class="panel-body el-account">
                    ...
                    <div class="row h4 account-info">
                        <div class="col-sm-4">
                            体验金待回收总额：<span class="text-primary">${expAccount.unReturnExpAmount?string("0.00")}元</span>
                        </div>
                        <div class="col-sm-4">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel1">绑定邮箱</h4>
            </div>
            <div class="modal-body">
