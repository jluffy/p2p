...
<div class="container" style="margin-top: 10px;">
    ...
    <div class="row">
                ...
                <tr>
                    <td colspan="2">
                        <div style="margin-bottom: 10px;" class="progress">
                            <div style="width: ${bidRequest.present}%"
                                 class="progress-bar progress-bar-info progress-bar-striped"></div>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <#if bidRequest.bidRequestState==1>
            ...
            <#elseif account?? && !self>
               <input id="usableAmount" autocomplete="off" value="${account.usableAmount?string('0.00')}"
                       type="hidden"/>
                <input id="minBidAmount" autocomplete="off" value="${bidRequest.minBidAmount?string('0.00')}"
                       type="hidden"/>
                <input id="maxBidAmount" autocomplete="off" value="${bidRequest.remainAmount?string('0.00')}"
                       type="hidden"/>
