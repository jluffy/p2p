		...
		$(function(){
            ...
            $("#uploadBtn1").uploadify({
               swf: '/js/plugins/uploadify/uploadify.swf',
                ...
                buttonText: '上传身份证正面',
                fileObjName: 'image',
                fileTypeDesc: '上传身份证正面',
                fileTypeExts: '*.jpg;*.png;*.jpeg;*.png',
                overrideEvents: ["onUploadSuccess", "onSelect"],//数组
                multi:false,
                onUploadSuccess: function (file, data) {
                  // console.log(data);
                    $("#uploadImg1").prop("src", data);//显示图片用
                    $("#uploadImage1").val(data);//向后台提交
                }
            });
            //上传身份证反面
            $("#uploadBtn2").uploadify({
               swf: '/js/plugins/uploadify/uploadify.swf',
                ...
                onUploadSuccess: function (file, data) {
                  // console.log(data);
                    $("#uploadImg2").prop("src", data);//显示图片用
                    $("#uploadImage2").val(data);//向后台提交
                }
            })
		});
		</script>
